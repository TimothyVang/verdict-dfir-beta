...
| `nist-hacking-case` | yes (remeasured 2026-07-09 under #189 matcher, `benchmark/RESULTS.md`) | SUSPICIOUS | **11/14 (79%)** live auto-run — passes above floor | coverage gap (not custody). Live `scripts/verdict` on `evidence/SCHARDT.dd` (`auto-f3f7a2e2-…`): scorer `recall: 11/14 = 79%`, `nhc-003: MATCHED` via `f-B-bulk-deleted-email-bcaaa39b`. Matches nhc-001 (ACMru), nhc-003 (bulk free-space carve recovered deleted-email lead), nhc-004 (hacking-tool MFT), nhc-005 (prefetch), nhc-006 (IE history), nhc-007 (shellbags), nhc-008 (LNK), nhc-009 (Recycle Bin), nhc-010 (SAM account), nhc-011 (OpenSaveMRU), nhc-014 (recon). Still unmatched: nhc-002 (USBSTOR empty on this image), nhc-012 (logon `.evt` empty / unsatisfiable), nhc-013 (no `Thumbs.db`). Committed `docs/sample-run/nist-hacking-case` remains historical at **10/14 (71%)** with `nhc-003: MISSED` (not regenerated). |
