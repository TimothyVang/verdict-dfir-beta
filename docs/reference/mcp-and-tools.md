...
- **46** = the **product tool surface** (33 Rust + 13 Python). This is the narrow, typed,
...
|---|---|---|---|---|---|
| 1 | `findevil-mcp` | stdio · `bash scripts/run-mcp-rust.sh` | 33 typed Rust DFIR tools | **Yes** | **Yes** |
...
## 2. Product tools — 46 total (33 Rust + 13 Python)
