...
const BOUNDARIES: Boundary[] = [
  ...
  { no: "03", label: "43 Rust DFIR Tools", sub: "findevil-mcp · typed IO · hash every output", note: "no execute_shell — the surface stays narrow" },
  ...
  return (
    <Scene page={2} caption="Architecture">
      ...
      <div style={{ position: "absolute", right: MARGIN, top: 196, width: 500 }}>
        ...
        >
          chain verifiable offline · 57 typed tools
        </div>
      </div>
